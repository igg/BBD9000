...
//! cBuffer structure
typedef volatile struct struct_cBuffer
{
	volatile unsigned char *dataptr;			///< the physical memory address where the buffer is stored
	volatile unsigned short size;			///< the allocated size of the buffer
	volatile unsigned short datalength;		///< the length of the data currently in the buffer
	volatile unsigned short dataindex;		///< the index into the buffer where the data starts
} cBuffer;
